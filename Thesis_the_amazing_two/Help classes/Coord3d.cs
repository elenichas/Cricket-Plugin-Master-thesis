...
namespace Thesis.Help_classes
{
    public struct Coord3D : IEquatable<Coord3D>
    {
        ...
        public static Coord3D Down => new Coord3D(0, 0, -1);

        public static Coord3D Up => new Coord3D(0, 0, 1);

        public static Coord3D Forward => new Coord3D(0, 1, 0);

        public static Coord3D Back => new Coord3D(0, -1, 0);
    }
}
